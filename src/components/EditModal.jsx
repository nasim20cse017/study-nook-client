                                    ...
                                    {amenitiesOptions.map((amenity) => {
                                        ...
                                        return (
                                            <button
                                                ...
                                                className={`group flex items-center justify-between rounded-2xl border p-4 transition-all duration-300 ${isSelected
                                            ...
                                            >
                                                <div className="flex items-center gap-3">
                                                    <div
                                                        className={`flex h-6 w-6 items-center justify-center rounded-full transition-all duration-300 ${isSelected
                                                    ...
                                                    <span
                                                        className={`font-semibold transition-colors duration-300 ${isSelected ? "text-pink-600" : "text-gray-700"
                                                            }`}
                                                    >
                                                        {amenity}
                                                    </span>
